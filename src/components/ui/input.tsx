  ...
  ({ className, type, tone = "editable", ...props }, ref) => {
    return (
      <input
        ...
        data-tone={tone}
        className={cn(
          "flex h-10 w-full rounded-md border bg-transparent px-3 py-1 text-base shadow-sm transition-all file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:border-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background md:text-sm",
          toneClass[tone],
          className,
        )}
        ref={ref}
